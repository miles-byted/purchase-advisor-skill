...
├── SKILL.md                      # 九步半方法论主体（v3.2.1：含任务承诺 + 候选盘点 + 处理深度证据 + 自查交代）
├── references/
│   └── trusted-reviewers.md      # 可信测评站名录 + 独立性/行货判断表
└── examples/
    ├── robot-vacuum-walkthrough.md   # 中国本土强势品类（中文 70%）实录，含假洋牌四查斐纳案例
    └── air-purifier-walkthrough.md   # 国际通用品类实录，含 18 行候选盘点 + 第六步半 5 个英文 Top 型号映射核查 + 第八步半自查交代认 3 个漏
```
...
想看输出长什么样？
- [扫地机器人实录](skills/cross-lingual-purchase-advisor/examples/robot-vacuum-walkthrough.md)（中国本土强势品类 · 中文 70%，含假洋牌四查斐纳案例 + 年度成本估算）
- [空气净化器实录](skills/cross-lingual-purchase-advisor/examples/air-purifier-walkthrough.md)（v3.2.1 反塌缩闸门实战 · 18 行候选盘点 + 5 个英文 Top 型号海内外映射核查 + 第八步半自查交代认 3 个漏）
